    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-12">
          <div
            className={`max-w-4xl w-full transition-all duration-800 ${
              isAnimating
          ...
          >
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: '0 20px 60px rgba(0, 0, 0, 0.5), inset 0 2px 8px rgba(0, 0, 0, 0.1)',
              }}
            >
              {/* Dynasty Number */}
              ...
              {/* Decorative Divider */}
              <div className="flex justify-center items-center gap-3 text-2xl" style={{ color: '#8B7355' }}>
                <span>𓊃</span>
                <div 
